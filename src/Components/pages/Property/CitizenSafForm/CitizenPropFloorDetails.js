...
import { allowFloatInput, getCurrentDate } from '../../Common/PowerUps/PowerupFunctions'
...
function CitizenPropFloorDetails(props) {
    ...
    return (
        <>
            ...
            <div className={`${AddFloorForm} fixed transition-all block md:w-full w-[90%] top-0 z-50 rounded-md ml-4`}>
  ...
  <div className='w-full flex justify-between m-2'>
                <div onClick={() => props.backFun(5)} className='px-4 py-1.5 text-sm text-white rounded-sm shadow-md bg-indigo-500 hover:bg-indigo-600 focus:bg-indigo-600 cursor-pointer'>
                    Back
                </div>
